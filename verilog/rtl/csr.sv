...
module csr (
  ...
  always_comb begin
    if (csr_win.cwren == 1 && csr_win.cwaddr == csr_rin.craddr && csr_rin.crden == 1 && csr_win.cwaddr != csr_minstret && csr_win.cwaddr != csr_minstreth) begin
      ...
      case (csr_rin.craddr)
        ...
        csr_mstatus:   csr_out.cdata = {csr_machine_reg.mstatus.sd, 8'h0, csr_machine_reg.mstatus.tsr, csr_machine_reg.mstatus.tw, csr_machine_reg.mstatus.tvm, csr_machine_reg.mstatus.mxr, csr_machine_reg.mstatus.summ, csr_machine_reg.mstatus.mprv, csr_machine_reg.mstatus.xs, csr_machine_reg.mstatus.fs, csr_machine_reg.mstatus.mpp, 2'h0, csr_machine_reg.mstatus.spp, csr_machine_reg.mstatus.mpie, 1'h0, csr_machine_reg.mstatus.spie, csr_machine_reg.mstatus.upie, csr_machine_reg.mstatus.mie, 1'h0, csr_machine_reg.mstatus.sie, csr_machine_reg.mstatus.uie};
        csr_mie:       csr_out.cdata = {20'h0, csr_machine_reg.mie.meie, 1'h0, csr_machine_reg.mie.seie, csr_machine_reg.mie.ueie, csr_machine_reg.mie.mtie, 1'h0, csr_machine_reg.mie.stie, csr_machine_reg.mie.utie, csr_machine_reg.mie.msie, 1'h0, csr_machine_reg.mie.ssie, csr_machine_reg.mie.usie};
        csr_mtvec:     csr_out.cdata = csr_machine_reg.mtvec;
        csr_mscratch:  csr_out.cdata = csr_machine_reg.mscratch;
        csr_mepc:      csr_out.cdata = csr_machine_reg.mepc;
        csr_mcause:    csr_out.cdata = csr_machine_reg.mcause;
        csr_mtval:     csr_out.cdata = csr_machine_reg.mtval;
        csr_mip:       csr_out.cdata = {20'h0, csr_machine_reg.mip.meip, 1'h0, csr_machine_reg.mip.seip, csr_machine_reg.mip.ueip, csr_machine_reg.mip.mtip, 1'h0, csr_machine_reg.mip.stip, csr_machine_reg.mip.utip, csr_machine_reg.mip.msip, 1'h0, csr_machine_reg.mip.ssip, csr_machine_reg.mip.usip};
    ...
    if (reset == 0) begin
      ...
      if (csr_win.cwren == 1) begin
        case (csr_win.cwaddr)
          ...
          csr_minstret:  csr_machine_reg.minstret <= {csr_machine_reg.minstret[63:32], csr_win.cdata} + incr;
          csr_minstreth: csr_machine_reg.minstret <= {csr_win.cdata, csr_machine_reg.minstret[31:0]} + incr;
      ...
      if (csr_ein.exception == 1) begin
        ...
        exception                    <= 1;
      end else if (csr_machine_reg.mstatus.mie == 1 && valid == 1 && ((csr_machine_reg.mie.meie == 1 && csr_machine_reg.mip.meip == 1) || (csr_machine_reg.mie.mtie == 1 && csr_machine_reg.mip.mtip == 1) || (csr_machine_reg.mie.msie == 1 && csr_machine_reg.mip.msip == 1))) begin
        csr_machine_reg.mstatus.mpie <= csr_machine_reg.mstatus.mie;
        csr_machine_reg.mstatus.mie  <= 0;
